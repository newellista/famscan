defmodule UiWeb.ContactControllerTest do
  use UiWeb.ConnCase

  alias Ui.Library

  @create_attrs %{email_address: "some email_address", first_name: "some first_name", last_name: "some last_name", phone_number: "some phone_number", title: "some title"}
  ...
  def fixture(:contact) do
    {:ok, contact} = Library.create_contact(@create_attrs)
    contact
  end
